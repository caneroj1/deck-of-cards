...
export default function Deck (jokers, decks = 1) {
  // init cards array
  var numCards = jokers ? 55 : 52
  var numDecks = Math.min(Math.max(decks, minDecks), maxDecks)
  var totalCards = numCards * numDecks
  var cards = new Array(totalCards)
